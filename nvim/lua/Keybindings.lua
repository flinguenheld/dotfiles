...
keymap('n', '<leader>tR',	'<cmd>lua require "telescope".extensions.file_browser.file_browser({hidden=true, cwd=require("telescope.utils").buffer_dir(), prompt_title="File browser (hidden files)"}) <CR>', opt)
